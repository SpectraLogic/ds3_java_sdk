...
public class Tape {
    ...
    public enum State {
        NORMAL, BAD, BARCODE_MISSING, DATA_CHECKPOINT_MISSING, DATA_CHECKPOINT_FAILURE, EJECT_FROM_EE_PENDING, EJECT_TO_EE_IN_PROGRESS, FORMAT_PENDING, IMPORT_IN_PROGRESS, LOST, LTFS_WITH_FOREIGN_DATA, OFFLINE, ONLINE_IN_PROGRESS, ONLINE_PENDING, PENDING_INSPECTION, SERIAL_NUMBER_MISMATCH, UNKNOWN, FOREIGN
    }
