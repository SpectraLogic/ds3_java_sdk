...
public class DataPolicyApiBean {
    ...
    private List<HumanReadableBucketApiBean> buckets = new ArrayList<>();
    ...
    @JsonProperty("DataPersistenceRules")
    @JacksonXmlElementWrapper(useWrapping = true)
    private List<DataPersistenceRuleApiBean> dataPersistenceRules = new ArrayList<>();

    @JsonProperty("DataReplicationRules")
    @JacksonXmlElementWrapper(useWrapping = true)
    private List<DataReplicationRuleApiBean> dataReplicationRules = new ArrayList<>();
    ...
    public List<HumanReadableBucketApiBean> getBuckets() {
        return this.buckets;
    }

    public void setBuckets(final List<HumanReadableBucketApiBean> buckets) {
    ...
    public List<DataPersistenceRuleApiBean> getDataPersistenceRules() {
        return this.dataPersistenceRules;
    }

    public void setDataPersistenceRules(final List<DataPersistenceRuleApiBean> dataPersistenceRules) {
        this.dataPersistenceRules = dataPersistenceRules;
    }


    public List<DataReplicationRuleApiBean> getDataReplicationRules() {
        return this.dataReplicationRules;
    }

    public void setDataReplicationRules(final List<DataReplicationRuleApiBean> dataReplicationRules) {
