...
@JacksonXmlRootElement(namespace = "JobSummary")
public class JobSummaryApiBean {
    ...
    private List<DestinationSummary> destinationSummaries = new ArrayList<>();
    ...
    public List<DestinationSummary> getDestinationSummaries() {
        return this.destinationSummaries;
    }

    public void setDestinationSummaries(final List<DestinationSummary> destinationSummaries) {
