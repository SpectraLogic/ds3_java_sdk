...
public class StorageDomainApiBean {
    ...
    @JsonProperty("StorageDomainMembers")
    @JacksonXmlElementWrapper(useWrapping = true)
    private List<StorageDomainMemberApiBean> storageDomainMembers = new ArrayList<>();
    ...
    public List<StorageDomainMemberApiBean> getStorageDomainMembers() {
        return this.storageDomainMembers;
    }

    public void setStorageDomainMembers(final List<StorageDomainMemberApiBean> storageDomainMembers) {
