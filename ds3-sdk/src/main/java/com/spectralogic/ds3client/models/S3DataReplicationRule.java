...
public class S3DataReplicationRule {
    ...
    @JsonProperty("InitialDataPlacement")
    ...
    public void setInitialDataPlacement(final S3InitialDataPlacementPolicy initialDataPlacement) {
