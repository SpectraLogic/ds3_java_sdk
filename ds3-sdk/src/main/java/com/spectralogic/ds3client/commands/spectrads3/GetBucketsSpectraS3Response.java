...
public class GetBucketsSpectraS3Response extends AbstractPaginationResponse {
    ...
    public GetBucketsSpectraS3Response(final BucketList bucketListResult, final Integer pagingTotalResultCount, final Integer pagingTruncated, final String checksum, final ChecksumType.Type checksumType) {
