...
public class GetUserSpectraS3ResponseParser extends AbstractResponseParser<GetUserSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200};

    @Override
    public GetUserSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new GetUserSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
