...
public class ModifyStorageDomainMemberSpectraS3Response extends AbstractResponse {
    ...
    public ModifyStorageDomainMemberSpectraS3Response(final StorageDomainMember storageDomainMemberResult, final String checksum, final ChecksumType.Type checksumType) {
