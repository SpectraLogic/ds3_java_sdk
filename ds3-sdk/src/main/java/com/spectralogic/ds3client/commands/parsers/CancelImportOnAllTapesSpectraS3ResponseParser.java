...
public class CancelImportOnAllTapesSpectraS3ResponseParser extends AbstractResponseParser<CancelImportOnAllTapesSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{204, 207};

    @Override
    public CancelImportOnAllTapesSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 207:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new CancelImportOnAllTapesSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
