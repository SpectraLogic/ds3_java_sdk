...
public class GetS3DataReplicationRuleSpectraS3Request extends AbstractRequest {
    ...
    public GetS3DataReplicationRuleSpectraS3Request(final String s3DataReplicationRule) {
