...
public class GetBulkJobSpectraS3ResponseParser extends AbstractResponseParser<GetBulkJobSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200};

    @Override
    public GetBulkJobSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                ...
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new GetBulkJobSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
