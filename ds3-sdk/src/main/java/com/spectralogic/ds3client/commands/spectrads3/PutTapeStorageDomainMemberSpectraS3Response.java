...
public class PutTapeStorageDomainMemberSpectraS3Response extends AbstractResponse {
    ...
    public PutTapeStorageDomainMemberSpectraS3Response(final StorageDomainMember storageDomainMemberResult, final String checksum, final ChecksumType.Type checksumType) {
