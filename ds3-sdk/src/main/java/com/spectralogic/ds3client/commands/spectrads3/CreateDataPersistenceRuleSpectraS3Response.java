...
public class CreateDataPersistenceRuleSpectraS3Response extends AbstractResponse {

    private DataPersistenceRule dataPersistenceRuleResult;

    public CreateDataPersistenceRuleSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
