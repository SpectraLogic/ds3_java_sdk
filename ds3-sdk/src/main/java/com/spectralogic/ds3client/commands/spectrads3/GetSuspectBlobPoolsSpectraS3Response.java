...
public class GetSuspectBlobPoolsSpectraS3Response extends AbstractPaginationResponse {
    ...
    public GetSuspectBlobPoolsSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
        ...
        try {
            ...
            case 200:
                try (final InputStream content = getResponse().getResponseStream()) {
                    this.suspectBlobPoolListResult = XmlOutput.fromXml(content, SuspectBlobPoolList.class);
                }
                break;
            default:
