...
public class CreateJobCompletedNotificationRegistrationSpectraS3Request extends AbstractCreateNotificationRequest {
    ...
    public CreateJobCompletedNotificationRegistrationSpectraS3Request(final String notificationEndPoint) {
        super(notificationEndPoint);

        
    }

    public CreateJobCompletedNotificationRegistrationSpectraS3Request withFormat(final HttpResponseFormatType format) {
        this.format = format;
        this.updateQueryParam("format", format.toString());
        return this;
    }

    public CreateJobCompletedNotificationRegistrationSpectraS3Request withJobId(final UUID jobId) {
        this.jobId = jobId;
        this.updateQueryParam("job_id", jobId.toString());
        return this;
    }

    public CreateJobCompletedNotificationRegistrationSpectraS3Request withNamingConvention(final NamingConventionType namingConvention) {
        this.namingConvention = namingConvention;
        this.updateQueryParam("naming_convention", namingConvention.toString());
        return this;
    }

    public CreateJobCompletedNotificationRegistrationSpectraS3Request withNotificationHttpMethod(final RequestType notificationHttpMethod) {
