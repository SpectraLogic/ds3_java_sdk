...
public class GetSuspectBlobTargetsSpectraS3Request extends AbstractPaginationRequest {
    ...
    public GetSuspectBlobTargetsSpectraS3Request withBlobId(final UUID blobId) {
