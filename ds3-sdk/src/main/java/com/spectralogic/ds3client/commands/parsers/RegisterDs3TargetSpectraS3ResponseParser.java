...
public class RegisterDs3TargetSpectraS3ResponseParser extends AbstractResponseParser<RegisterDs3TargetSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{201};

    @Override
    public RegisterDs3TargetSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 201:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new RegisterDs3TargetSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
