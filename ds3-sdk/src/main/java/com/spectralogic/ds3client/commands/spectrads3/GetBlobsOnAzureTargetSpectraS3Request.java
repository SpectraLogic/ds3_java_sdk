...
public class GetBlobsOnAzureTargetSpectraS3Request extends AbstractRequest {
    ...
    public GetBlobsOnAzureTargetSpectraS3Request(final String azureTarget, final List<Ds3Object> objects) {
