...
public class PutAzureTargetReadPreferenceSpectraS3Response extends AbstractResponse {
    
    private final AzureTargetReadPreference azureTargetReadPreferenceResult;

    public PutAzureTargetReadPreferenceSpectraS3Response(final AzureTargetReadPreference azureTargetReadPreferenceResult, final String checksum, final ChecksumType.Type checksumType) {
