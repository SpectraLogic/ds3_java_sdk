...
public class GetActiveJobsSpectraS3Response extends AbstractPaginationResponse {
    ...
    private final ActiveJobList activeJobListResult;

    public GetActiveJobsSpectraS3Response(final ActiveJobList activeJobListResult, final Integer pagingTotalResultCount, final Integer pagingTruncated, final String checksum, final ChecksumType.Type checksumType) {
        super(pagingTotalResultCount, pagingTruncated, checksum, checksumType);
        this.activeJobListResult = activeJobListResult;
    }
