...
public class VerifyPhysicalPlacementForObjectsSpectraS3ResponseParser extends AbstractResponseParser<VerifyPhysicalPlacementForObjectsSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200};

    @Override
    public VerifyPhysicalPlacementForObjectsSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new VerifyPhysicalPlacementForObjectsSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
