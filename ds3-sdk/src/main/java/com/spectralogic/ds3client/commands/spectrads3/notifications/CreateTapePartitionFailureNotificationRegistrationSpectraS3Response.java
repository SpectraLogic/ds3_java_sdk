...
public class CreateTapePartitionFailureNotificationRegistrationSpectraS3Response extends AbstractResponse {

    private TapePartitionFailureNotificationRegistration tapePartitionFailureNotificationRegistrationResult;

    public CreateTapePartitionFailureNotificationRegistrationSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
