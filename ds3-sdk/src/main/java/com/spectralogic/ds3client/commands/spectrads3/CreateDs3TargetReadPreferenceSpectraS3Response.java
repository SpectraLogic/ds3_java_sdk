...
public class CreateDs3TargetReadPreferenceSpectraS3Response extends AbstractResponse {

    private Ds3TargetReadPreference ds3TargetReadPreferenceResult;

    public CreateDs3TargetReadPreferenceSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
