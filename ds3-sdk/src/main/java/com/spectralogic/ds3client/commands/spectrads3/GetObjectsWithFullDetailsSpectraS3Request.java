...
public class GetObjectsWithFullDetailsSpectraS3Request extends AbstractRequest {
    ...
    public GetObjectsWithFullDetailsSpectraS3Request withFolder(final String folder) {
        this.folder = folder;
        this.updateQueryParam("folder", UrlEscapers.urlFragmentEscaper().escape(folder).replace('+', ' '));
        return this;
    }
