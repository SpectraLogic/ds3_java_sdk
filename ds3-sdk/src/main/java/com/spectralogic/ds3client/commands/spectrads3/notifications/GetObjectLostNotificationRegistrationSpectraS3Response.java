...
public class GetObjectLostNotificationRegistrationSpectraS3Response extends AbstractResponse {
    ...
    public GetObjectLostNotificationRegistrationSpectraS3Response(final S3ObjectLostNotificationRegistration s3ObjectLostNotificationRegistrationResult, final String checksum, final ChecksumType.Type checksumType) {
