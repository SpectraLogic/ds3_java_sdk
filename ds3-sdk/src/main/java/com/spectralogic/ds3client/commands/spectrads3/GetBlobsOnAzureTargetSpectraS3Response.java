...
public class GetBlobsOnAzureTargetSpectraS3Response extends AbstractResponse {
    
    private final BulkObjectList bulkObjectListResult;

    public GetBlobsOnAzureTargetSpectraS3Response(final BulkObjectList bulkObjectListResult, final String checksum, final ChecksumType.Type checksumType) {
