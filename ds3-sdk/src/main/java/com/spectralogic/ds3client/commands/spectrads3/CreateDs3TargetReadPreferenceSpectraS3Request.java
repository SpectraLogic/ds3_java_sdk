...
public class CreateDs3TargetReadPreferenceSpectraS3Request extends AbstractRequest {
    ...
    public CreateDs3TargetReadPreferenceSpectraS3Request(final String bucketId, final TargetReadPreference readPreference, final UUID targetId) {
