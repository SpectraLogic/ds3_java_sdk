...
public class GetObjectCachedNotificationRegistrationsSpectraS3Request extends AbstractPaginationRequest {
    ...
    public GetObjectCachedNotificationRegistrationsSpectraS3Request withPageLength(final int pageLength) {
    ...
    public GetObjectCachedNotificationRegistrationsSpectraS3Request withPageOffset(final int pageOffset) {
