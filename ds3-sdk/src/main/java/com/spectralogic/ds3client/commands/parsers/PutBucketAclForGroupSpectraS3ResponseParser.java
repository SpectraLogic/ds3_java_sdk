...
public class PutBucketAclForGroupSpectraS3ResponseParser extends AbstractResponseParser<PutBucketAclForGroupSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{201};

    @Override
    public PutBucketAclForGroupSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 201:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new PutBucketAclForGroupSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
