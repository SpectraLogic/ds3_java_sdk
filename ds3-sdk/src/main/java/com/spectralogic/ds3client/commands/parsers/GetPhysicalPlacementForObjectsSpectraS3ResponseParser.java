...
public class GetPhysicalPlacementForObjectsSpectraS3ResponseParser extends AbstractResponseParser<GetPhysicalPlacementForObjectsSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200};

    @Override
    public GetPhysicalPlacementForObjectsSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new GetPhysicalPlacementForObjectsSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
