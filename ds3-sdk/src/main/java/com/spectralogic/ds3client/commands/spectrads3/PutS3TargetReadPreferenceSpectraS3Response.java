...
public class PutS3TargetReadPreferenceSpectraS3Response extends AbstractResponse {
    
    private final S3TargetReadPreference s3TargetReadPreferenceResult;

    public PutS3TargetReadPreferenceSpectraS3Response(final S3TargetReadPreference s3TargetReadPreferenceResult, final String checksum, final ChecksumType.Type checksumType) {
