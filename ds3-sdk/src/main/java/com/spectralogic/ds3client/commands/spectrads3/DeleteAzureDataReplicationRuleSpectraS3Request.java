...
public class DeleteAzureDataReplicationRuleSpectraS3Request extends AbstractRequest {
    ...
    public DeleteAzureDataReplicationRuleSpectraS3Request(final String azureDataReplicationRule) {
