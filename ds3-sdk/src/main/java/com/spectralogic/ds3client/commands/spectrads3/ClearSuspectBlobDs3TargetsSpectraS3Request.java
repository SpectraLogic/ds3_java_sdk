...
public class ClearSuspectBlobDs3TargetsSpectraS3Request extends AbstractIdsPayloadRequest {
    ...
    public ClearSuspectBlobDs3TargetsSpectraS3Request(final List<String> ids) {
        super(ids);
        
    }

    public ClearSuspectBlobDs3TargetsSpectraS3Request withForce(final boolean force) {
        this.force = force;
        if (this.force) {
