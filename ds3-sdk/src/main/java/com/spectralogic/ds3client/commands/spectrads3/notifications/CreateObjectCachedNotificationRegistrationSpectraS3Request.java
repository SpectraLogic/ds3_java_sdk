...
public class CreateObjectCachedNotificationRegistrationSpectraS3Request extends AbstractCreateNotificationRequest {
    ...
    public CreateObjectCachedNotificationRegistrationSpectraS3Request(final String notificationEndPoint) {
    ...
    public CreateObjectCachedNotificationRegistrationSpectraS3Request withFormat(final HttpResponseFormatType format) {
        this.format = format;
        this.updateQueryParam("format", format.toString());
        return this;
    }

    public CreateObjectCachedNotificationRegistrationSpectraS3Request withJobId(final UUID jobId) {
        this.jobId = jobId;
        this.updateQueryParam("job_id", jobId.toString());
        return this;
    }

    public CreateObjectCachedNotificationRegistrationSpectraS3Request withNamingConvention(final NamingConventionType namingConvention) {
        this.namingConvention = namingConvention;
        this.updateQueryParam("naming_convention", namingConvention.toString());
        return this;
    }

    public CreateObjectCachedNotificationRegistrationSpectraS3Request withNotificationHttpMethod(final RequestType notificationHttpMethod) {
