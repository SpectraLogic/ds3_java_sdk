...
public class GetDataPlannerBlobStoreTasksSpectraS3Response extends AbstractResponse {
    ...
    private BlobStoreTasksInformation blobStoreTasksInformationResult;

    public GetDataPlannerBlobStoreTasksSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
