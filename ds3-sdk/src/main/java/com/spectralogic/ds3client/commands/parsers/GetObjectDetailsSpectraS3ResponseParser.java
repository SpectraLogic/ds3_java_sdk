...
public class GetObjectDetailsSpectraS3ResponseParser extends AbstractResponseParser<GetObjectDetailsSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200};

    @Override
    public GetObjectDetailsSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new GetObjectDetailsSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
