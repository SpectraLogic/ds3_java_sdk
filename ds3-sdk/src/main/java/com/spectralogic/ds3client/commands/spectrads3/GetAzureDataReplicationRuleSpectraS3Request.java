...
public class GetAzureDataReplicationRuleSpectraS3Request extends AbstractRequest {
    ...
    public GetAzureDataReplicationRuleSpectraS3Request(final String azureDataReplicationRule) {
