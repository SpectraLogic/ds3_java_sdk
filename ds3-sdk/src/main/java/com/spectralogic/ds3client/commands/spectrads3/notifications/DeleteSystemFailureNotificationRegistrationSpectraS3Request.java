...
public class DeleteSystemFailureNotificationRegistrationSpectraS3Request extends AbstractDeleteNotificationRequest {

    //Variables
    
    //Constructor
    
    public DeleteSystemFailureNotificationRegistrationSpectraS3Request(final UUID notificationId) {
