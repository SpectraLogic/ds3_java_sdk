...
public class GetPhysicalPlacementForObjectsFullDetailsSpectraS3Response extends AbstractResponse {

    private BlobApiBeansContainer blobApiBeansContainerResult;

    public GetPhysicalPlacementForObjectsFullDetailsSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
