...
public class CreateTapeFailureNotificationRegistrationSpectraS3Request extends AbstractCreateNotificationRequest {
    ...
    public CreateTapeFailureNotificationRegistrationSpectraS3Request(final String notificationEndPoint) {
    ...
    public CreateTapeFailureNotificationRegistrationSpectraS3Request withFormat(final HttpResponseFormatType format) {
        this.format = format;
        this.updateQueryParam("format", format.toString());
        return this;
    }

    public CreateTapeFailureNotificationRegistrationSpectraS3Request withNamingConvention(final NamingConventionType namingConvention) {
        this.namingConvention = namingConvention;
        this.updateQueryParam("naming_convention", namingConvention.toString());
        return this;
    }

    public CreateTapeFailureNotificationRegistrationSpectraS3Request withNotificationHttpMethod(final RequestType notificationHttpMethod) {
