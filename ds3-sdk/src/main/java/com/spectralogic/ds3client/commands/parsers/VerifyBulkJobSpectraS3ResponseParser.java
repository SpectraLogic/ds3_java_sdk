...
public class VerifyBulkJobSpectraS3ResponseParser extends AbstractResponseParser<VerifyBulkJobSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200};

    @Override
    public VerifyBulkJobSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new VerifyBulkJobSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
