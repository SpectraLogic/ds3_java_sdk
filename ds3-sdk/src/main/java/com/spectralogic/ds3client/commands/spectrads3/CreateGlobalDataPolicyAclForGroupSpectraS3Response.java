...
public class CreateGlobalDataPolicyAclForGroupSpectraS3Response extends AbstractResponse {

    private DataPolicyAcl dataPolicyAclResult;

    public CreateGlobalDataPolicyAclForGroupSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
