...
public class GetObjectCachedNotificationRegistrationSpectraS3Response extends AbstractResponse {
    ...
    public GetObjectCachedNotificationRegistrationSpectraS3Response(final S3ObjectCachedNotificationRegistration s3ObjectCachedNotificationRegistrationResult, final String checksum, final ChecksumType.Type checksumType) {
