...
public class ReplicatePutJobSpectraS3ResponseParser extends AbstractResponseParser<ReplicatePutJobSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200, 204};

    @Override
    public ReplicatePutJobSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new ReplicatePutJobSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
