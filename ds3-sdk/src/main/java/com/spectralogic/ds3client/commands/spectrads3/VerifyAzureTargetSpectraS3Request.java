...
public class VerifyAzureTargetSpectraS3Request extends AbstractRequest {
    ...
    public VerifyAzureTargetSpectraS3Request(final String azureTarget) {
    ...
    public VerifyAzureTargetSpectraS3Request withFullDetails(final boolean fullDetails) {
