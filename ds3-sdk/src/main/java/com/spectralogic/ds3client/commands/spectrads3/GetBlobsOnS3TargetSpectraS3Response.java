...
public class GetBlobsOnS3TargetSpectraS3Response extends AbstractResponse {
    
    private final BulkObjectList bulkObjectListResult;

    public GetBlobsOnS3TargetSpectraS3Response(final BulkObjectList bulkObjectListResult, final String checksum, final ChecksumType.Type checksumType) {
