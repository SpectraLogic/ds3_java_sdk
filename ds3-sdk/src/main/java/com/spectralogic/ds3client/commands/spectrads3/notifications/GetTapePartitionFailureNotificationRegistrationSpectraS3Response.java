...
public class GetTapePartitionFailureNotificationRegistrationSpectraS3Response extends AbstractResponse {
    
    private final TapePartitionFailureNotificationRegistration tapePartitionFailureNotificationRegistrationResult;

    public GetTapePartitionFailureNotificationRegistrationSpectraS3Response(final TapePartitionFailureNotificationRegistration tapePartitionFailureNotificationRegistrationResult, final String checksum, final ChecksumType.Type checksumType) {
    ...
    public TapePartitionFailureNotificationRegistration getTapePartitionFailureNotificationRegistrationResult() {
        return this.tapePartitionFailureNotificationRegistrationResult;
    }
