...
public class GetCacheThrottleRuleSpectraS3Response extends AbstractResponse {
    
    private final CacheThrottleRule cacheThrottleRuleResult;

    public GetCacheThrottleRuleSpectraS3Response(final CacheThrottleRule cacheThrottleRuleResult, final String checksum, final ChecksumType.Type checksumType) {
