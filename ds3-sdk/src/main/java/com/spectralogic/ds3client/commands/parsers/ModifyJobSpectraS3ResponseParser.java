...
public class ModifyJobSpectraS3ResponseParser extends AbstractResponseParser<ModifyJobSpectraS3Response> {
    private final int[] expectedStatusCodes = new int[]{200};

    @Override
    public ModifyJobSpectraS3Response parseXmlResponse(final WebResponse response) throws IOException {
        ...
        if (ResponseParserUtils.validateStatusCode(statusCode, expectedStatusCodes)) {
            ...
            case 200:
                try (final InputStream inputStream = response.getResponseStream()) {
                    ...
                    return new ModifyJobSpectraS3Response(result, this.getChecksum(), this.getChecksumType());
                }
