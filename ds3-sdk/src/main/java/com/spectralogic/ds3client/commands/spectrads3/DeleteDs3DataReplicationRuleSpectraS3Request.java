...
public class DeleteDs3DataReplicationRuleSpectraS3Request extends AbstractRequest {
    ...
    public DeleteDs3DataReplicationRuleSpectraS3Request(final String ds3DataReplicationRule) {
