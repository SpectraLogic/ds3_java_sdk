...
public class GetDegradedBucketsSpectraS3Response extends AbstractPaginationResponse {

    private final BucketList bucketListResult;

    public GetDegradedBucketsSpectraS3Response(final BucketList bucketListResult, final Integer pagingTotalResultCount, final Integer pagingTruncated, final String checksum, final ChecksumType.Type checksumType) {
