...
public class PutS3TargetFailureNotificationRegistrationSpectraS3Request extends AbstractRequest {
    ...
    public PutS3TargetFailureNotificationRegistrationSpectraS3Request withNamingConvention(final NamingConventionType namingConvention) {
    ...
    public PutS3TargetFailureNotificationRegistrationSpectraS3Request withNotificationHttpMethod(final RequestType notificationHttpMethod) {
