...
public class GetS3TargetReadPreferenceSpectraS3Request extends AbstractRequest {
    ...
    public GetS3TargetReadPreferenceSpectraS3Request(final String s3TargetReadPreference) {
