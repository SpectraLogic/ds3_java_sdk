...
public class DeleteS3DataReplicationRuleSpectraS3Request extends AbstractRequest {
    ...
    public DeleteS3DataReplicationRuleSpectraS3Request(final String s3DataReplicationRule) {
