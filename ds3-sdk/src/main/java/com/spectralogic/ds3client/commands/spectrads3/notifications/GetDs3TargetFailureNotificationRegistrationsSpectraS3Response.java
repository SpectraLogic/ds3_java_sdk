...
public class GetDs3TargetFailureNotificationRegistrationsSpectraS3Response extends AbstractPaginationResponse {
    ...
    public GetDs3TargetFailureNotificationRegistrationsSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
        ...
        try {
            ...
            case 200:
                try (final InputStream content = getResponse().getResponseStream()) {
                    this.ds3TargetFailureNotificationRegistrationListResult = XmlOutput.fromXml(content, Ds3TargetFailureNotificationRegistrationList.class);
                }
                break;
            default:
