...
public class GetDegradedDs3DataReplicationRulesSpectraS3Response extends AbstractPaginationResponse {

    private final Ds3DataReplicationRuleList ds3DataReplicationRuleListResult;

    public GetDegradedDs3DataReplicationRulesSpectraS3Response(final Ds3DataReplicationRuleList ds3DataReplicationRuleListResult, final Integer pagingTotalResultCount, final Integer pagingTruncated, final String checksum, final ChecksumType.Type checksumType) {
