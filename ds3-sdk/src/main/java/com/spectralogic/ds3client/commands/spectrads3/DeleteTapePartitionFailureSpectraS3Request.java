...
public class DeleteTapePartitionFailureSpectraS3Request extends AbstractRequest {
    ...
    public DeleteTapePartitionFailureSpectraS3Request(final String tapePartitionFailure) {
