...
public class CreateGlobalDataPolicyAclForUserSpectraS3Response extends AbstractResponse {

    private DataPolicyAcl dataPolicyAclResult;

    public CreateGlobalDataPolicyAclForUserSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
