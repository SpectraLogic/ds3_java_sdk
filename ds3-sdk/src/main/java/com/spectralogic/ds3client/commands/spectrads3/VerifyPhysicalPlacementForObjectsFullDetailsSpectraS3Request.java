...
public class VerifyPhysicalPlacementForObjectsFullDetailsSpectraS3Request extends AbstractRequest {
    ...
    // Constructor
    public VerifyPhysicalPlacementForObjectsFullDetailsSpectraS3Request(final String bucketName, final List<Ds3Object> objects) {
    ...
    public VerifyPhysicalPlacementForObjectsFullDetailsSpectraS3Request withStorageDomainId(final UUID storageDomainId) {
