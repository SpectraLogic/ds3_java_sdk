...
public class DeleteDs3TargetReadPreferenceSpectraS3Request extends AbstractRequest {

    // Variables
    
    private final String ds3TargetReadPreference;
    ...
    public String getDs3TargetReadPreference() {
