...
public class GetDegradedDataPersistenceRulesSpectraS3Request extends AbstractPaginationRequest {
    ...
    public GetDegradedDataPersistenceRulesSpectraS3Request withState(final DataPlacementRuleState state) {
        this.state = state;
