...
public class GetDs3DataReplicationRuleSpectraS3Request extends AbstractRequest {
    ...
    public GetDs3DataReplicationRuleSpectraS3Request(final String ds3DataReplicationRule) {
