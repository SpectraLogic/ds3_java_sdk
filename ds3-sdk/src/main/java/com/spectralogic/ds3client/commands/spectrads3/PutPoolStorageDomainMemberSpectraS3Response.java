...
public class PutPoolStorageDomainMemberSpectraS3Response extends AbstractResponse {
    ...
    public PutPoolStorageDomainMemberSpectraS3Response(final StorageDomainMember storageDomainMemberResult, final String checksum, final ChecksumType.Type checksumType) {
