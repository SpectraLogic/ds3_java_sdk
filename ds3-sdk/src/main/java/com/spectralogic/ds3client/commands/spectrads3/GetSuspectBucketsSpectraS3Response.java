...
public class GetSuspectBucketsSpectraS3Response extends AbstractPaginationResponse {

    private final BucketList bucketListResult;

    public GetSuspectBucketsSpectraS3Response(final BucketList bucketListResult, final Integer pagingTotalResultCount, final Integer pagingTruncated, final String checksum, final ChecksumType.Type checksumType) {
