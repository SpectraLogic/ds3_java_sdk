...
public class CreateDataPolicyAclForUserSpectraS3Response extends AbstractResponse {

    private DataPolicyAcl dataPolicyAclResult;

    public CreateDataPolicyAclForUserSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
