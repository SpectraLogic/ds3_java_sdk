...
public class CreateObjectPersistedNotificationRegistrationSpectraS3Response extends AbstractResponse {

    private S3ObjectPersistedNotificationRegistration s3ObjectPersistedNotificationRegistrationResult;

    public CreateObjectPersistedNotificationRegistrationSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
