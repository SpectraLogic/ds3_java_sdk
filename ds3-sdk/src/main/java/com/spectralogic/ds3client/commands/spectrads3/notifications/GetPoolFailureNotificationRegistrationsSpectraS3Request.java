...
public class GetPoolFailureNotificationRegistrationsSpectraS3Request extends AbstractPaginationRequest {
    ...
    public GetPoolFailureNotificationRegistrationsSpectraS3Request withPageLength(final int pageLength) {
    ...
    public GetPoolFailureNotificationRegistrationsSpectraS3Request withPageOffset(final int pageOffset) {
    ...
    public GetPoolFailureNotificationRegistrationsSpectraS3Request withUserId(final String userId) {
        this.userId = userId;
        this.updateQueryParam("user_id", userId);
        return this;
    }
