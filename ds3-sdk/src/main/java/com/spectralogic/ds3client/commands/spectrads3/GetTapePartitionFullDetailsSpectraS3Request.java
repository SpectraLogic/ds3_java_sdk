...
public class GetTapePartitionFullDetailsSpectraS3Request extends AbstractRequest {
    ...
    // Constructor
    public GetTapePartitionFullDetailsSpectraS3Request(final String tapePartition) {
