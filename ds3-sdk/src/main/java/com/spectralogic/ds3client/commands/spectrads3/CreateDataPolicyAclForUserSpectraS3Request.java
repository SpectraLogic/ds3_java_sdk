...
public class CreateDataPolicyAclForUserSpectraS3Request extends AbstractRequest {
    ...
    // Constructor
    public CreateDataPolicyAclForUserSpectraS3Request(final String dataPolicyAcl, final UUID dataPolicyId, final UUID userId) {
