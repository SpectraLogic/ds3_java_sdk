...
public class GetPhysicalPlacementForObjectsSpectraS3Response extends AbstractResponse {
    ...
    public GetPhysicalPlacementForObjectsSpectraS3Response(final PhysicalPlacement physicalPlacementResult, final String checksum, final ChecksumType.Type checksumType) {
