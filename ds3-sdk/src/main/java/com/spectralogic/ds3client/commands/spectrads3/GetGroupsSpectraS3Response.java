...
public class GetGroupsSpectraS3Response extends AbstractPaginationResponse {
    ...
    private final GroupList groupListResult;

    public GetGroupsSpectraS3Response(final GroupList groupListResult, final Integer pagingTotalResultCount, final Integer pagingTruncated, final String checksum, final ChecksumType.Type checksumType) {
