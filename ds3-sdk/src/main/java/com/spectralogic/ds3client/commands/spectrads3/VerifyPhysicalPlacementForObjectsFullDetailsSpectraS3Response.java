...
public class VerifyPhysicalPlacementForObjectsFullDetailsSpectraS3Response extends AbstractResponse {

    private BlobApiBeansContainer blobApiBeansContainerResult;

    public VerifyPhysicalPlacementForObjectsFullDetailsSpectraS3Response(final WebResponse response) throws IOException {
        super(response);
    }
